...
import (
	...
	"dev.latticeruntime.com/slog/v3/internal/entryjson"
	"dev.latticeruntime.com/slog/v3/sloggers/slogjson"
)
...
func TestMake(t *testing.T) {
	...
	exp := fmt.Sprintf(`{"level":"ERROR","msg":"line1\n\nline2","caller":"%v:35","func":"dev.latticeruntime.com/slog/v3/sloggers/slogjson_test.TestMake","logger_names":["named"],"trace":"%v","span":"%v","fields":{"wowow":"me\nyou"}}
...
func TestNoDriverValue(t *testing.T) {
	...
	j := entryjson.Filter(b.String(), "ts")
	exp := fmt.Sprintf(`{"level":"ERROR","msg":"error!","caller":"%v:61","func":"dev.latticeruntime.com/slog/v3/sloggers/slogjson_test.TestNoDriverValue","logger_names":["named"],"fields":{"inval":null,"val":"cat","int":42}}
`, slogjsonTestFile)
	assert.Equal(t, "entry", exp, j)
}
